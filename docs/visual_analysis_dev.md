...
- **DB** `visual_analyses` table (`supabase/migrations/20260606122313_add_visual_analyses.sql`)
...
## One-time setup
1. **DB:** apply `supabase/migrations/20260606122313_add_visual_analyses.sql` — ships via the **DB migrate** CI workflow on merge (see `supabase/README.md`).
